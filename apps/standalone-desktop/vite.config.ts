...
export default defineConfig({
  ...
  resolve: {
    // Standalone client: deps are installed in this app's own node_modules
    // (isolated from the repo workspace), and shared is vendored in-tree —
    // so all of these resolve locally, not at the repo root.
    alias: {
